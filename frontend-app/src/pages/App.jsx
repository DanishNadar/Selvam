...
export default function App() {
  ...
  const pages = {
    dashboard: <Dashboard globalTickers={globalTickers} setGlobalTickers={setGlobalTickers} riskProfile={riskProfile} setRiskProfile={setRiskProfile} navigate={setPage} />,
    merger: <MergerLab globalTickers={globalTickers} setGlobalTickers={setGlobalTickers} riskProfile={riskProfile} />,
